...
set(KORTEX_FLAGS_DEBUG     "${KORTEX_FLAGS_DEBUG}   -std=c++0x ")
set(KORTEX_FLAGS_RELEASE   "${KORTEX_FLAGS_RELEASE} -std=c++0x -rdynamic")

set(CMAKE_CXX_FLAGS_DEBUG   "${KORTEX_FLAGS_DEBUG}"  )
set(CMAKE_CXX_FLAGS_RELEASE "${KORTEX_FLAGS_RELEASE}")
