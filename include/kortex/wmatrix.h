...
namespace kortex {
    ...
    public:
        ...
        void copy( const WMatrix& rhs, int sr, int sc, int srsz, int scsz, int dr, int dc );
        void copy( const WMatrix& rhs, int dr, int dc );
...
///
    ...
    inline bool mat_inv( const WMatrix& A, WMatrix& iA ) {
    ...
    inline void mat_mat( const WMatrix& A, const WMatrix& B, WMatrix& C ) {
        C.resize( A.h(), B.w() );
    ...
    inline void mat_mat_trans( const WMatrix& A, const WMatrix& B, WMatrix& C ) {
        C.resize( A.h(), B.h() );
    ...
    inline void mat_trans_mat( const WMatrix& A, const WMatrix& B, WMatrix& C ) {
        C.resize( A.w(), B.w() );
    ...
    inline void mat_mat_mat_trans( const WMatrix& A, const WMatrix& B, const WMatrix& C,
                                   WMatrix& D ) {
        D.resize( A.h(), C.h() );
    ...
    inline void mat_mat_mat( const WMatrix& A, const WMatrix& B, const WMatrix& C,
                             WMatrix& D ) {
        D.resize( A.h(), C.w() );
    ...
    inline void mat_trans_mat_mat( const WMatrix& A, const WMatrix& B, const WMatrix& C,
                                   WMatrix& D ) {
        D.resize( A.w(), C.w() );
    ...
    inline void mat_mat_elem( const WMatrix& A, const WMatrix& B, WMatrix& C ) {
        C.resize( A.h(), A.w() );
    ...
    inline void mat_minus_mat( const WMatrix& A, const WMatrix& B, WMatrix& C ) {
        C.resize( A.h(), A.w() );
    ...
    inline void mat_plus_mat( const WMatrix& A, const WMatrix& B, WMatrix& C ) {
        C.resize( A.h(), A.w() );
    ...
    inline void cross_matrix( const WMatrix& b, WMatrix& Bx ) {
        assert_statement( b.size() == 3, "invalid b matrix" );
        Bx.resize( 3, 3 );
        mat_cross_form( b.get_pointer(), 3, Bx.get_pointer(), Bx.size() );
    }

    inline void mat_ABAt( const WMatrix& A, const WMatrix& B,
                          WMatrix& C ) {
        C.resize( A.h(), A.h() );
    ...
    inline bool mat_inv_3( const WMatrix& A, WMatrix& iA, double inversion_threshold ) {
    ...
    inline bool mat_solve_Ax_b_3( const WMatrix& A, const WMatrix& b, WMatrix& x ) {
    ...
    inline void mat_concat_hor( const WMatrix& A, const WMatrix& B, WMatrix& cAB ) {
    ...
    inline void mat_concat_ver( const WMatrix& A, const WMatrix& B, WMatrix& cAB ) {
    ...
    inline void mat_deconcat_hor( const WMatrix& AB, WMatrix& A, WMatrix& B ) {
    ...
    inline double mat_pseudo_inv( const WMatrix& A, WMatrix& iA ) {
        iA.resize( A.w(), A.h() );
